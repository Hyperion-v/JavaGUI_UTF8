package com.dut.swing.components.tree;
		...
		if (ae.getActionCommand().equals("删除节点")) {
			...
			if (treepath != null) {
				...
				DefaultMutableTreeNode selectionNode = (DefaultMutableTreeNode) treepath
						.getLastPathComponent();
				com.dut.swing.components.tree.TreeNode parent = (com.dut.swing.components.tree.TreeNode) selectionNode.getParent();
				if (parent != null) {
	...
	class MouseHandle extends MouseAdapter {
		public void mousePressed(MouseEvent e) {
			try {
				...
				com.dut.swing.components.tree.TreeNode treenode = (TreeNode) treepath.getLastPathComponent();
